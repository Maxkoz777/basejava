...
public class TestData {
    ...
    public static final Resume R1 = new Resume(UUID_1, "new1");

    public static final String UUID_2 = UUID.randomUUID().toString();
    public static final Resume R2 = new Resume(UUID_2, "new2");

    public static final String UUID_3 = UUID.randomUUID().toString();
    public static final Resume R3 = new Resume(UUID_3, "new3");

    public static final String UUID_4 = UUID.randomUUID().toString();
    public static final Resume R4 = new Resume(UUID_4, "new4");
